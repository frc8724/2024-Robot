...
public class AutoStartRightScore2 extends SequentialCommandGroup {
  /** Creates a new AutoStartLeftScore2. */
  public AutoStartRightScore2() {
    ...
    addCommands(
        ...
        new DriveForDistance(1.7, 45, 0, 1.0),
        new DriveForDistance(1.7, 0.0, 0, 1.0),
        new DriveForDistance(-1.7, 0.0, 0.0, 1.0),
        new DriveForDistance(-1.7, 45, 45, 1.0),
        new DriveForDistance(0.0, 45, 40, 0.0), // stop
