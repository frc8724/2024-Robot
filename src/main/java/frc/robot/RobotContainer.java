...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        m_auto.addAuto(new AutoStartLeftShootDriveOut());
        m_auto.addAuto(new AutoStartLeftScore2());
        m_auto.addAuto(new AutoStartRightShootandTrap());
        m_auto.addAuto(new AutoStartRightShootDriveOut());
        m_auto.addAuto(new AutoStartRightScore2());
    ...
    private void configureBindings() {
        ...
        // trap shot
        m_operatorController.button(3).onTrue(new ShootNote(3500));
